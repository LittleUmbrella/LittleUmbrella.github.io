//define('becu_org.domain.model.Base', ['js!JS.Class!order', 'JSextend', 'js!ko!order', 'eaf.util', 'eaf.core'], function () {
    eaf.util.namespace('becu_org.domain.model');
    becu_org.domain.model.Base = (function () {
        return new JS.Class({
            initialize: function () {
                //properties
...
//    return becu_org.domain.model.Base;
//});