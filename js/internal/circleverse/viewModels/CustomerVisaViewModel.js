...
circleverse.viewModel.CustomerVisaViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    return new JS.Class('circleverse.viewModel.CustomerVisaViewModel', circleverse.viewModel.ResizeableBase, {
