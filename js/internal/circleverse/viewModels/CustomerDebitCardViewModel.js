...
circleverse.viewModel.CustomerDebitCardViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    return new JS.Class('circleverse.viewModel.CustomerDebitCardViewModel', circleverse.viewModel.ResizeableBase, {
 ...
 self.size = ko.observable(initSize);
            ...
            self.icon.name('icon-briefcase icon-size-2x');
