...
circleverse.viewModel.BusinessServiceViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    //var that;
    return new JS.Class('circleverse.viewModel.BusinessServiceViewModel', circleverse.viewModel.ResizeableBase, {
