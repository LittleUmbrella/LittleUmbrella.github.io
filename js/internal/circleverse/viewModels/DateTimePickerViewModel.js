...
circleverse.viewModel.DateTimePickerViewModel = (function () {

    var initSize = 94;

    return new JS.Class('circleverse.viewModel.DateTimePickerViewModel', circleverse.viewModel.ResizeableBase, {
     ...
     initialize: function (object, parent, globalSettings, opts) {// (tracker, uri, templateUri, templateId, resultTemplateUri, callSpec, name, id, businessClass, opts) {
         ...
         this.icon.name('icon-filter icon-size-3x');
