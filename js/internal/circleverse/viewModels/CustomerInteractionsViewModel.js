...
circleverse.viewModel.CustomerInteractionsViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    //var that;
    return new JS.Class('circleverse.viewModel.CustomerInteractionsViewModel', circleverse.viewModel.ResizeableBase, {
 ...
 self.size = ko.observable(initSize);
            ...
            this.icon.url = ko.observable('url("/media/img/interaction64x64.png")');


            this.icon.name('icon-interactions icon-size-2x');
