...
circleverse.viewModel.BecuPurseViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    //var that;
    return new JS.Class('circleverse.viewModel.BecuPurseViewModel', circleverse.viewModel.ResizeableBase, {
 ...
 self.size = ko.observable(initSize);
            ...
            this.icon.url = ko.observable('url("/media/img/safe48x48.png")');

            this.icon.name('icon-safe icon-size-2x');
