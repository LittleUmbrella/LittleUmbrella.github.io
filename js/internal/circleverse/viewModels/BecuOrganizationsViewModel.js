...
littleUmbrella.circleverse.viewModel.BecuOrganizationsViewModel = (function () {

    var error = function () {
        //todo: display error JS.Interface.ensure(this.config.tracker, ITemplateTracker);
    };

    return new JS.Class('littleUmbrella.circleverse.viewModel.BecuOrganizationsViewModel', circleverse.viewModel.ResizeableBase, {
