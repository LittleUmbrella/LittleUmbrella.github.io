...
circleverse.viewModel.CustomerFinanceManagementViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    return new JS.Class('circleverse.viewModel.CustomerFinanceManagementViewModel', circleverse.viewModel.ResizeableBase, {
 ...
 self.size = ko.observable(initSize);
            ...
            self.icon.name('icon-bar-chart-o icon-size-2x');
