...
circleverse.viewModel.CustomerFilesViewModel = (function () {

    //any global variables here will be in scope for ALL instances
    //of the JS Class, not just one instance

    return new JS.Class('circleverse.viewModel.CustomerFilesViewModel', circleverse.viewModel.ResizeableBase, {
