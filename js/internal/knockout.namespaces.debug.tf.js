...
(function (ko) {
    ...
    */
    ...
    ko.applyBindings = function (viewModel, namespace, rootNode) {
        ...
        //will be changed next time through anyway
        //found that for auto-updates that check this property,
        //it would be lost if reset too soon
        //ko.currentlyBindingNamespace = '';
    };
        ...
        return {
            ...
            memoizeBindingAttributeSyntax: function (htmlString, templateEngine) {
                return htmlString.replace(memoizeBindingAttributeSyntaxRegex, function (match) {
                    ...
                    var namespace = (undefined === arguments[6]) ? (undefined === ko.currentlyBindingNamespace) ? '' : 'non' + ko.currentlyBindingNamespace : arguments[6].slice(1);
