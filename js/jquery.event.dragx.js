                    ...
                    switch (handleObj.type) {
                            ...
                            $el.drag("init", function (ev, dd) {
                                ...
                                if ('undefined' !== typeof (settings.multiSelector) && settings.multiSelector != null && settings.multiSelector != '' && $this.is(settings.multiSelector)) {
                                    ...
                                    selecteds.each(function () {
                                        $(this).triggerHandler($fndragxprototype.eventNames.dragxinit, arguments);
                                    });
                        ...
                        case $fndragxprototype.eventNames.dragxstart:
                            $el.drag("start", function (ev, dd) {
                                ...
                                $this.triggerHandler($fndragxprototype.eventNames.dragxstart, arguments);
                            });
                            break;
                            ...
                            $el.drag(function (ev, dd) {
                                ...
                                if (!settings.multiDragDrop) {
                                    ...
                                    if (!dragdata.dragging) {
                                        ...
                                        $this.triggerHandler($fndragxprototype.eventNames.dragx, arguments);
                                        return;
                                    }
                                }
                                            ...
                                            if (activeOb) {
                                                ...
                                                if (idx != -1) {
                                                    ...
                                                    if (activeOb.activators.length == 1) {
                                                        ...
                                                        $(this).triggerHandler("dropxout", arguments);
                                                        //log('removed');
                                                    }
                                                    //remove from list
                                ...
                                $(realDrop).each(function () {
                                    ...
                                    if ($.fn.dropx)
                                        $(this).triggerHandler($.fn.dropx.prototype.eventNames.dropxover, arguments);
                                });
                            ...
                            $el.drag("end", function (ev, dd) {
                                ...
                                if (!settings.multiDragDrop) {
                                    ...
                                    if (!dragdata.dragging) {
                                        ...
                                        $this.triggerHandler($fndragx.prototype.eventNames.dragxend, arguments);
